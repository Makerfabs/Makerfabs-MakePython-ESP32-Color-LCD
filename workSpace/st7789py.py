...
class ST77xx:
    def __init__(self, spi, width, height, reset, dc, cs=None, backlight=None,
        ...
        if spi is None:
            import machine
            #self.spi = machine.SPI(1, baudrate=10000000, phase=0, polarity=1)
            self.spi  = machine.SPI(1, baudrate=10000000, polarity=1, phase=0, sck=Pin(14), mosi=Pin(13), miso=Pin(12))#HSPI
        self.reset = reset
        self.dc = dc
        self.cs = cs
        self.backlight = backlight
        #self.font=font.FONT6_8()
    ...
    def text(self, font, message, row=32, column=0, color=WHITE):
        '''
            ...
            if 32 <= char <= 127:
                ...
                for vect in range (3, len(data), 2):
                    ...
                    if not vect or penup:
                        ...
                        self.line(from_x, from_y, to_x, to_y, color)
